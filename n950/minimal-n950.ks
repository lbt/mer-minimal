# -*-mic2-options-*- -f fs --copy-kernel --record-pkgs=name --pkgmgr=yum --arch=armv7hl  -*-mic2-options-*-
# 
...
repo --name=ce-adaptation-n950 --baseurl=http://repo.pub.meego.com/CE:/Adaptation:/N950-N9/CE_Adaptation_N9xx-common_armv7hl/ --save
